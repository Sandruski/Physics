...
void ModulePhysics::CreateCircle(int mouse_x, int mouse_y, int rad) {
	b2BodyDef body;
	body.type = b2_dynamicBody;
...
void ModulePhysics::CreateRectangle(int mouse_x, int mouse_y, int hx, int hy) {
	b2BodyDef body;
	body.type = b2_dynamicBody;
	float radius = PIXEL_TO_METERS(rad);
	body.position.Set(PIXEL_TO_METERS(mouse_x), PIXEL_TO_METERS(mouse_y));
...
void ModulePhysics::CreateChain(int mouse_x, int mouse_y, int rad) {
	b2BodyDef body;
	body.type = b2_dynamicBody;
	float radius = PIXEL_TO_METERS(rad);
	body.position.Set(PIXEL_TO_METERS(mouse_x), PIXEL_TO_METERS(mouse_y));
